...
class _ParamScheduler:
    ...
    def __init__(self,
                 optimizer: Union[OptimWrapper, Optimizer],
                 param_name: str,
                 begin: int = 0,
                 end: int = INF,
                 last_step: int = -1,
...
class CosineRestartParamScheduler(_ParamScheduler):
    ...
    @staticmethod
    def get_position_from_periods(iteration: int, cumulative_periods: List[int]) -> Optional[int]:
...
class ReduceOnPlateauParamScheduler(_ParamScheduler):
    ...
    def __init__(self,
        ...
        if isinstance(min_value, (list, tuple)):
            ...
            if isinstance(optimizer, OptimWrapper) and optimizer.base_param_settings is not None:
