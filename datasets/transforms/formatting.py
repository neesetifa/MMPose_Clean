...
from structures import MultilevelPixelData, PoseDataSample, InstanceData, PixelData
...
class PackPoseInputs:
    ...
    def transform(self, results: dict) -> dict:
        ...
        # pack instance data
        # these data are just transformed data from original image to target image
        ...
        # these labels are real labels for loss function
