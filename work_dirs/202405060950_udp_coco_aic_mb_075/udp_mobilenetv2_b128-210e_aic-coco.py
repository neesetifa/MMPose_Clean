...
# codec settings
codec = dict(
    type='UDPHeatmap', input_size=(192, 256), heatmap_size=(48, 64), sigma=2) # (192,256),(48,64)
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='pretrained_weight/0_imagenet/mobilenet_v2_0.75x_pretrained_backbone.pth',
        )
    ),
    head=dict(
        type='HeatmapHead',
